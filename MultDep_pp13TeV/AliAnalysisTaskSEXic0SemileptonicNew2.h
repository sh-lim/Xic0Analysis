...
#ifndef AliAnalysisTaskSEXic0SemileptonicNew2_H
#define AliAnalysisTaskSEXic0SemileptonicNew2_H
...
class AliAnalysisTaskSEXic0SemileptonicNew2 : public AliAnalysisTaskSE
{
  public:

    //enum {  kPP, kPA, kAA, kUnknownCollType  }; 

    AliAnalysisTaskSEXic0SemileptonicNew2();
    AliAnalysisTaskSEXic0SemileptonicNew2( const char *name, const char *option );
    AliAnalysisTaskSEXic0SemileptonicNew2( const AliAnalysisTaskSEXic0SemileptonicNew2& ap );
    AliAnalysisTaskSEXic0SemileptonicNew2& operator = ( const AliAnalysisTaskSEXic0SemileptonicNew2& ap );
    ~AliAnalysisTaskSEXic0SemileptonicNew2();
  ...
  private:
    ...
    Float_t* fEventTreeVariable = nullptr; //!
		Float_t* fMCeTreeVariable = nullptr; //!

    AliESDtrackCuts* fTrackCuts = nullptr; //!
    AliESDtrackCuts* fTrackCutsCase0 = nullptr; //!
    AliESDtrackCuts* fTrackCutsCase1 = nullptr; //!
    AliESDtrackCuts* fTrackCutsCase2 = nullptr; //!
    AliESDtrackCuts* fTrackCutsCase3 = nullptr; //!
    AliESDtrackCuts* fTrackCutsCase4 = nullptr; //!
    AliESDtrackCuts* fTrackCutsCase5 = nullptr; //!
    ...
    ClassDef(AliAnalysisTaskSEXic0SemileptonicNew2, 2);
};
