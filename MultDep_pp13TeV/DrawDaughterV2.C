void DrawDaughterV2(){
	...
	infile[0] = new TFile("outfile_XiEfficiencyV5_pp_pythia6.root");
	infile[1] = new TFile("outfile_XiEfficiencyV5_pp_pythia8.root");
	infile[2] = new TFile("outfile_XiEfficiencyV5_pPb_pythia6.root");
	infile[3] = new TFile("outfile_XiEfficiencyV5_pPb_pythia8.root");

	TH3D *hTrueXi[nset];
	TH3D *hTrueEe[nset];
	TH3D *hTrueEe_Xic0rap0[nset];
	TH3D *hTrueEe_Xic0rap1[nset];
	TH3D *hTrueEe_Xic0rap2[nset];
	TH3D *hTrueEe_Xic0rap3[nset];

	TH2D *hTrueXiEtaPt[nset];
	TH2D *hTrueEeEtaPt[nset];
	TH2D *hTrueEeEtaPt_Xic0rap0[nset];
	TH2D *hTrueEeEtaPt_Xic0rap1[nset];
	TH2D *hTrueEeEtaPt_Xic0rap2[nset];
	TH2D *hTrueEeEtaPt_Xic0rap3[nset];
	...
	for (int iset=0; iset<nset; iset++){
		...
		hTrueEe_Xic0rap0[iset] = (TH3D*)infile[iset]->Get("hTrueEe_Xic0rap0");
		hTrueEe_Xic0rap1[iset] = (TH3D*)infile[iset]->Get("hTrueEe_Xic0rap1");
		hTrueEe_Xic0rap2[iset] = (TH3D*)infile[iset]->Get("hTrueEe_Xic0rap2");
		hTrueEe_Xic0rap3[iset] = (TH3D*)infile[iset]->Get("hTrueEe_Xic0rap3");
		...
		hTrueEeEtaPt_Xic0rap0[iset] = (TH2D*)hTrueEe_Xic0rap0[iset]->Project3D(Form("hTrueEeEtaPt_Xic0rap0_set%d_yz",iset));
		hTrueEeEtaPt_Xic0rap1[iset] = (TH2D*)hTrueEe_Xic0rap1[iset]->Project3D(Form("hTrueEeEtaPt_Xic0rap1_set%d_yz",iset));
		hTrueEeEtaPt_Xic0rap2[iset] = (TH2D*)hTrueEe_Xic0rap2[iset]->Project3D(Form("hTrueEeEtaPt_Xic0rap2_set%d_yz",iset));
		hTrueEeEtaPt_Xic0rap3[iset] = (TH2D*)hTrueEe_Xic0rap3[iset]->Project3D(Form("hTrueEeEtaPt_Xic0rap3_set%d_yz",iset));
	...
	TCanvas *c100 = new TCanvas("c100","c100",1.1*4*250,4*250);
	c100->Divide(4,4);
	...
	for (int iset=0; iset<nset; iset++){
		...
		c100->cd(4*iset + 1);
		gPad->SetMargin(0.15,0.13,0.12,0.03);
		TH1D* htmp = (TH1D*)gPad->DrawFrame(-2.5,0,2.5,3);
		htmp->GetXaxis()->SetTitle("#eta");
		htmp->GetXaxis()->SetTitleSize(0.05);
		htmp->GetYaxis()->SetTitle("p_{T} [GeV/c]");
		htmp->GetYaxis()->SetTitleSize(0.05);
		hTrueEeEtaPt_Xic0rap0[iset]->Draw("colz same");

		c100->cd(4*iset + 2);
		gPad->SetMargin(0.15,0.13,0.12,0.03);
		htmp = (TH1D*)gPad->DrawFrame(-2.5,0,2.5,3);
		htmp->GetXaxis()->SetTitle("#eta");
		htmp->GetXaxis()->SetTitleSize(0.05);
		htmp->GetYaxis()->SetTitle("p_{T} [GeV/c]");
		htmp->GetYaxis()->SetTitleSize(0.05);
		hTrueEeEtaPt_Xic0rap1[iset]->Draw("colz same");
		...
		htmp->GetYaxis()->SetTitle("p_{T} [GeV/c]");
		htmp->GetYaxis()->SetTitleSize(0.05);
		hTrueEeEtaPt_Xic0rap2[iset]->Draw("colz same");
		...
		htmp->GetYaxis()->SetTitle("p_{T} [GeV/c]");
		htmp->GetYaxis()->SetTitleSize(0.05);
		hTrueEeEtaPt_Xic0rap3[iset]->Draw("colz same");
