AliAnalysisTaskSEXic0SemileptonicNew2* AddMyTaskXic0New2(TString name = "name", TString option = "option")
{
    ...
    if (!mgr->GetInputEventHandler()) {
		...
		AliAnalysisTaskSEXic0SemileptonicNew2* task = new AliAnalysisTaskSEXic0SemileptonicNew2(name.Data(), Form("%s%s",name.Data(),option.Data()));   
		if(!task) return 0x0;
