...
AliAnalysisTaskSEXic0SemileptonicEvent::AliAnalysisTaskSEXic0SemileptonicEvent() :
  AliAnalysisTaskSE("AliAnalysisTaskSEXic0SemileptonicEvent"),
  fOption(){
...
//___________________________________________________________________
AliAnalysisTaskSEXic0SemileptonicEvent::AliAnalysisTaskSEXic0SemileptonicEvent( const char *name, const char *option ) :
...
//___________________________________________________________________
AliAnalysisTaskSEXic0SemileptonicEvent::AliAnalysisTaskSEXic0SemileptonicEvent( const AliAnalysisTaskSEXic0SemileptonicEvent& ap ) :
  AliAnalysisTaskSE("AliAnalysisTaskSEXic0SemileptonicEvent"),
  fOption(ap.fOption) {;}

//___________________________________________________________________
AliAnalysisTaskSEXic0SemileptonicEvent& AliAnalysisTaskSEXic0SemileptonicEvent::operator = ( const AliAnalysisTaskSEXic0SemileptonicEvent& ap ) {
  // assignment operator
  this->~AliAnalysisTaskSEXic0SemileptonicEvent();
  new(this) AliAnalysisTaskSEXic0SemileptonicEvent(ap);
  return *this;
}
//___________________________________________________________________
AliAnalysisTaskSEXic0SemileptonicEvent::~AliAnalysisTaskSEXic0SemileptonicEvent(){
...
//___________________________________________________________________
void AliAnalysisTaskSEXic0SemileptonicEvent::UserCreateOutputObjects(){
...
//___________________________________________________________________
void AliAnalysisTaskSEXic0SemileptonicEvent::UserExec(Option_t* ){
  // Pointer to a event----------------------------------------------------
  ...
  Bool_t IsMinimumBias = kFALSE;
	...
	if(!fPIDResponse) printf("AliAnalysisTaskSEXic0SemileptonicEvent No PIDd\n");
  ...
  fHistos->FillTH1("hEventNumbers","Goodzcut",1);
	...
	//cout << fV0MValue << " " << fV0MCentrality << " " << fSPDValue << " " << fSPDCentrality << endl;
...
void AliAnalysisTaskSEXic0SemileptonicEvent::CheckXic0Info(AliAODTrack *trk, AliAODcascade *casc){
...
///////////////////////////////Filtering///////////////////////////////////
Bool_t AliAnalysisTaskSEXic0SemileptonicEvent::FilterTrack(AliAODTrack * track, Int_t FillHistosFlag){
...
Bool_t AliAnalysisTaskSEXic0SemileptonicEvent::FilterElectron(AliAODTrack *etrk, Double_t &minmass, Double_t &minmass_ss, Bool_t IsSameSign, Bool_t IsLoose, Int_t FillHistosFlag){
...
Bool_t AliAnalysisTaskSEXic0SemileptonicEvent::FilterCascade(AliAODcascade *casc){
  Bool_t isparticle = kTRUE;
  if(casc->ChargeXi()>0) isparticle = kFALSE;
...
void AliAnalysisTaskSEXic0SemileptonicEvent::FillMCXic0(AliAODMCParticle *mcpart){
...
Bool_t AliAnalysisTaskSEXic0SemileptonicEvent::FillMCXib(AliAODMCParticle *mcpart){
...
void AliAnalysisTaskSEXic0SemileptonicEvent::FillBottomContribution(AliAODMCParticle *mcpart, AliAODcascade *casc, AliAODTrack *trk){
...
void AliAnalysisTaskSEXic0SemileptonicEvent::FillPairEleXi(AliAODcascade *casc, AliAODTrack *trk){
...
void AliAnalysisTaskSEXic0SemileptonicEvent::FillXiHistFromPromptNonPrompt(Bool_t IsMC, AliAODcascade *casc){
  if(!IsMC) return;
  Bool_t isparticle = kTRUE;
  if(casc->ChargeXi()>0) isparticle = kFALSE;
...
Int_t AliAnalysisTaskSEXic0SemileptonicEvent::MatchToMCXib(AliAODcascade *casc, AliAODTrack *trk){
...
Int_t AliAnalysisTaskSEXic0SemileptonicEvent::MatchToMCXic0(AliAODcascade *casc, AliAODTrack *trk){
  Int_t Xi_label = MatchToMCXi(casc); if(!Xi_label) return -1;
  AliAODMCParticle* mcXi = (AliAODMCParticle*) fMC->GetTrack(Xi_label);
...
Int_t AliAnalysisTaskSEXic0SemileptonicEvent::MatchToMCXic0(AliAODcascade *casc){
  Int_t Xi_label = MatchToMCXi(casc); if(!Xi_label) return -1;
  AliAODMCParticle* mcXi = (AliAODMCParticle*) fMC->GetTrack(Xi_label);
...
Int_t AliAnalysisTaskSEXic0SemileptonicEvent::MatchToMCXi(AliAODcascade* casc){
...
Int_t AliAnalysisTaskSEXic0SemileptonicEvent::MatchToMCele(AliAODTrack* trk){
...
Bool_t AliAnalysisTaskSEXic0SemileptonicEvent::StandardCutFlag(AliAODTrack *track, AliAODcascade *casc, Bool_t e_reco, Bool_t e_pid, Bool_t Xi_reco, Bool_t Xi_pid){
  //-------------------------------------eletron-------------------------------------
  if(e_reco){
...
//___________________________________________________________________
void AliAnalysisTaskSEXic0SemileptonicEvent::FinishTaskOutput() {}
                //fOutput->Write();
//___________________________________________________________________
void AliAnalysisTaskSEXic0SemileptonicEvent::Terminate(Option_t*) {}

//___________________________________________________________________
//_____________________Define Tree Valuable___________________________
//___________________________________________________________________

void AliAnalysisTaskSEXic0SemileptonicEvent::DefineMCCutTree(){
...
void AliAnalysisTaskSEXic0SemileptonicEvent::DefinePaireXiTree(){
...
void AliAnalysisTaskSEXic0SemileptonicEvent::DefineMCPaireXiTree(){
  fMCTree = new TTree("MCTree","MCTree");
  vector <TString> fTreeVariableName = {"mcpTe","mcecharge","mcpTv","mcvcharge","mcpTXic0","mcpTeXi","mcXicMass","c_flag","b_flag","mcpTXib","mceXipTb","mcXibMass"};
...
void AliAnalysisTaskSEXic0SemileptonicEvent::DefineEventTree(){
...
unsigned int AliAnalysisTaskSEXic0SemileptonicEvent::GetEvID() {
