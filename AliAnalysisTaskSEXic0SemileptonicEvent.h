...
#ifndef AliAnalysisTaskSEXic0SemileptonicEvent_H
#define AliAnalysisTaskSEXic0SemileptonicEvent_H
...
class AliAnalysisTaskSEXic0SemileptonicEvent : public AliAnalysisTaskSE
{
  public:

    //enum {  kPP, kPA, kAA, kUnknownCollType  }; 

    AliAnalysisTaskSEXic0SemileptonicEvent();
    AliAnalysisTaskSEXic0SemileptonicEvent( const char *name, const char *option );
    AliAnalysisTaskSEXic0SemileptonicEvent( const AliAnalysisTaskSEXic0SemileptonicEvent& ap );
    AliAnalysisTaskSEXic0SemileptonicEvent& operator = ( const AliAnalysisTaskSEXic0SemileptonicEvent& ap );
    ~AliAnalysisTaskSEXic0SemileptonicEvent();
  ...
  private:
    ...
    ClassDef(AliAnalysisTaskSEXic0SemileptonicEvent, 2);
};
